...
"""``NetworkXDataSetE`` loads and saves graphs to a JSON with a custom encoder file using an underlying
...
from eos.utils import NumpyEncoder


class NetworkXDataSetE(AbstractVersionedDataSet):
    """``NetworkXDataSetE`` loads and saves graphs to a JSON file using an
    underlying filesystem (e.g.: local, S3, GCS). ``NetworkX`` is used to
    create JSON data.
    See https://networkx.org/documentation/stable/tutorial.html for details of original class.
    ...
    ::
        ...
        >>> graph_dataset = NetworkXDataSetE(filepath="test.json")
    ...
    def _save(self, data: networkx.Graph) -> None:
        ...
        with self._fs.open(save_path, **self._fs_open_args_save) as fs_file:
            json.dump(json_graph, fs_file, cls=NumpyEncoder)
